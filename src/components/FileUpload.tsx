...
const FileUpload = ({ onFileSelect, disabled = false }: FileUploadProps) => {
    ...
    return (
        <div
            className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${isDragging ? 'border-[#30B3A4] bg-[#30B3A4]/20' : 'border-gray-600 hover:border-gray-500'
